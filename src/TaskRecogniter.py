...
def filltercommand(command):
      ...
      print(command)
      if "hey computer" in command or "a computer" in command or "hello computer" in command:
          command = command.replace("hey computer", "").replace("a computer","").replace("hello computer","")
          if "play" in command:
             player.play(command)
             return
          if "open" in command:
          ...
          if "take web screenshot" in command or "take a web screenshot" in command:
              kit.web_screenshot(((str(command).lower()).replace("take","").replace("web","").replace("of","").replace("a","")))
          if "what can you do" in command or "help" in command:
              ...
              VoiceEngine.say("I Can Open Website By Your Voice Command Just Say Open And The Website You Want To Open It.")
              VoiceEngine.say("I Can Play Music By Your Voice Command Just Say Play And The Name Of The Song To Play It . You Can Provide Additional Command Such As Youtube Or Spotify So I Will Play The Song On That Platform You Specified.")
          ...
          if "guide me" in command:
              ...
              if (huggingfacehub_api_token != "null"):
                  VoiceEngine.say("User Acces Token For Huggingface is set")
                  filltercommand("hey computer what can you do")
              ...
              if "i have" in command or "i got " in command or "yes" in command:   
                ...
                return
                  ...
                  if "yes" in command or "sure" in command or "open" in command:
                      ...
                      return
          if "user access token" in command:
              VoiceEngine.say("After You Got The User Access Token Open My Folder Which Will Be Located At C Drive And A Open The File Named dot env and paste the access token to next huggingface api key , and your done ")
              return
          ...
          if "about you" in command:
              VoiceEngine.say("I am an AI-powered language model developed by Vignesh, known as Wingman. My purpose is to assist and provide information And Be Your personal assistant, created to provide dedicated support and assistance. Fun Fact It Took One Day To Build Me.")
              return
